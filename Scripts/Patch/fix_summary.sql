--fix inboundorder duplicate
delete from toolinventoryhistory where inboundorderid in (7587,
7588,
7589)
GO

delete from inboundorderdetail where inboundorderid in (7587,
7588,
7589)
GO

delete from inboundorder where inboundorderid in (7587,
7588,
7589)
GO
